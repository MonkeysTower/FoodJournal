...
const HomeScreen = ({ route }) => {
  ...
  const [activeTab, setActiveTab] = useState('add'); // Добавляем состояние для активной вкладки
  ...
  const loadJournals = async () => {
    try {
      ...
      console.error('Error loading journals:', error.message || error);
                ...
                <View style={styles.hiddenButtons}>
                  <TouchableOpacity
                    ...
                    onPress={() => {
                      ...
                      setActiveTab('add'); // Переключаемся на вкладку "Add Dish" при редактировании
                    }}
                  >
